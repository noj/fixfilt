  ...
  fix::Schema load_schema ()
  {
    ...
    schema[549] = fix::FieldDef{
      ...
      {{"1", "CROSS_TRADE_WHICH_IS_EXECUTED_COMPLETELY_OR_NOT_BOTH_SIDES_ARE_"
       ...
       {"2",
        "CROSS_TRADE_WHICH_IS_EXECUTED_PARTIALLY_AND_THE_REST_IS_CANCELLED_ONE_"
        "SIDE_IS_FULLY_EXECUTED_THE_OTHER_SIDE_IS_PARTIALLY_EXECUTED_WITH_THE_"
        "REMAINDER_BEING_CANCELLED_THIS_IS_EQUIVALENT_TO_AN_IMMEDIATE_OR_"
        "CANCEL_ON_THE_OTHER_SIDE_NOTE_THE_CROSSPRIORITZATION"},
       {"3",
    ...
    schema[574] = fix::FieldDef{
      ...
      {{"A1",
       ...
       {"M1",
        "EXACT_MATCH_ON_TRADE_DATE_STOCK_SYMBOL_QUANTITY_PRICE_TRADE_TYPE_AND_"
        "SPECIAL_TRADE_INDICATOR_MINUS_BADGES_AND_TIMES_ACT_M1_MATCH"},
