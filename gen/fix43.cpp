  ...
  fix::Schema load_schema ()
  {
    ...
    schema[235] = fix::FieldDef{
      ...
      {{"TRUE", "TRUE_YIELD_THE_YIELD_CALCULATED_WITH_COUPON_DATES_MOVED_FROM_"
       ...
       {"LONGAVGLIFE",
        "YIELD_TO_LONGEST_AVERAGE_LIFE_THE_YIELD_ASSUMING_ONLY_MANDATORY_SINKS_"
        "ARE_TAKEN_THIS_RESULTS_IN_A_LOWER_PAYDOWN_OF_DEBT_THE_YIELD_IS_THEN_"
        "CALCULATED_TO_THE_FINAL_PAYMENT_DATE"},
       {"MATURITY",
       ...
       {"TAXEQUIV",
        "TAX_EQUIVALENT_YIELD_THE_AFTER_TAX_YIELD_GROSSED_UP_BY_THE_MAXIMUM_"
        "FEDERAL_TAX_RATE_OF_396_FOR_COMPARISON_TO_TAXABLE_YIELDS"},
       {"ANNUAL",
        "ANNUAL_YIELD_THE_ANNUAL_INTEREST_OR_DIVIDEND_INCOME_AN_INVESTMENT_"
        "EARNS_EXPRESSED_AS_A_PERCENTAGE_OF_THE_INVESTMENTS_TOTAL_VALUE"},
       ...
       {"AVGMATURITY",
        "YIELD_TO_AVERAGE_MATURITY_THE_YIELD_ACHIEVED_BY_SUBSTITUTING_A_BONDS_"
        "AVERAGE_MATURITY_FOR_THE_ISSUES_FINAL_MATURITY_DATE"},
       ...
       {"COMPOUND",
        "COMPOUND_YIELD_THE_YIELD_OF_CERTAIN_JAPANESE_BONDS_BASED_ON_ITS_PRICE_"
        "CERTAIN_JAPANESE_BONDS_HAVE_IRREGULAR_FIRST_OR_LAST_COUPONS_AND_THE_"
        "YIELD_IS_CALCULATED_COMPOUND_FOR_THESE_IRREGULAR_PERIODS"},
       ...
       {"GOVTEQUIV",
        "GOVERNMENT_EQUIVALENT_YIELD_ASK_YIELD_BASED_ON_SEMI_ANNUAL_COUPONS_"
        "COMPOUNDING_IN_ALL_PERIODS_AND_ACTUAL_ACTUAL_CALENDAR"},
       {"INFLATION",
        "YIELD_WITH_INFLATION_ASSUMPTION_BASED_ON_PRICE_THE_RETURN_AN_INVESTOR_"
        "WOULD_REQUIRE_ON_A_NORMAL_BOND_THAT_WOULD_MAKE_THE_REAL_RETURN_EQUAL_"
        "TO_THAT_OF_THE_INFLATION_INDEXED_BOND_ASSUMING_A_CONSTANT_INFLATION_"
        "RATE"},
       {"INVERSEFLOATER", "INVERSE_FLOATER_BOND_YIELD_INVERSE_FLOATER_SEMI_"
                          "ANNUAL_BOND_EQUIVALENT_RATE"},
       {"LASTQUARTER",
        "CLOSING_YIELD_MOST_RECENT_QUARTER_THE_YIELD_OF_A_BOND_BASED_ON_THE_"
        "CLOSING_PRICE_AS_OF_THE_MOST_RECENT_QUARTERS_END"},
       {"LASTCLOSE", "MOST_RECENT_CLOSING_YIELD_THE_LAST_AVAILABLE_YIELD_"
                     "STORED_IN_HISTORY_COMPUTED_USING_PRICE"},
       {"LASTMONTH",
        "CLOSING_YIELD_MOST_RECENT_MONTH_THE_YIELD_OF_A_BOND_BASED_ON_THE_"
        "CLOSING_PRICE_AS_OF_THE_MOST_RECENT_MONTHS_END"},
       {"CLOSE",
    ...
    schema[549] = fix::FieldDef{
      ...
      {{"1", "CROSS_TRADE_WHICH_IS_EXECUTED_COMPLETELY_OR_NOT_BOTH_SIDES_ARE_"
       ...
       {"3",
        "CROSS_TRADE_WHICH_IS_PARTIALLY_EXECUTED_WITH_THE_UNFILLED_PORTIONS_"
        "REMAINING_ACTIVE_ONE_SIDE_OF_THE_CROSS_IS_FULLY_EXECUTED"},
       {"4",
    ...
    schema[574] = fix::FieldDef{
      ...
      {{"S5", "SUMMARIZED_MATCH_USING_A1_TO_A5_EXACT_MATCH_CRITERIA_EXCEPT_"
       ...
       {"A3",
        "EXACT_MATCH_ON_TRADE_DATE_STOCK_SYMBOL_QUANTITY_PRICE_TRADE_TYPE_AND_"
        "SPECIAL_TRADE_INDICATOR_PLUS_TWO_BADGES_AND_EXECUTION_TIME"},
       {"A4",
       ...
       {"A1",
        "EXACT_MATCH_ON_TRADE_DATE_STOCK_SYMBOL_QUANTITY_PRICE_TRADE_TYPE_AND_"
        "SPECIAL_TRADE_INDICATOR_PLUS_FOUR_BADGES_AND_EXECUTION_TIME"},
